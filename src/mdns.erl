...
-moduledoc """
Public API: register a `.local` name to announce over mDNS.
...
-doc """
Register `Name` (must end in `.local`) to announce `Ip` over mDNS.
...
-doc "Equivalent to `register_service(InstanceName, ServiceType, Port, TxtKVs, TargetHost, #{})`.".
...
-doc """
Publish a DNS-SD (RFC 6763) service instance over mDNS: a
...
-doc """
Withdraw a name registered with `register/2,3` or
...
-doc """
Call this when the embedding system detects that the configured
